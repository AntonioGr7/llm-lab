...
**Pre-run checkpoints exist.** The expensive runs (the pretraining demo in Module 11, the GRPO run in Module 15) have checkpoints committed to the repo. If you want to run them yourself, great. If you'd rather spend your budget on smaller experiments, also great — you can pick up from any stage.
