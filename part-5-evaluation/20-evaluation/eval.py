"""Module 20 evaluation CLI — produce a scorecard for one model/checkpoint.
...
Examples:
    ...
    # Score a GRPO checkpoint from Module 18, GSM8K only, with pass@k
    python eval.py --config=configs/eval_qwen3_1.7b.yaml \\
...
def _parse_args(argv=None):
    p = argparse.ArgumentParser(description="Module 20 evaluation harness")
