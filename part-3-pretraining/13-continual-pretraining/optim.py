"""Optimizer construction for Module 13 — Continual Pretraining.

Copied from Module 15's `optim.py`, trimmed to the single path CPT needs:
...
def build_optimizer(
    ...
    if cfg.type != "adamw":
        raise ValueError(
            f"Module 13 ships AdamW only; got optimizer.type={cfg.type!r}. "
