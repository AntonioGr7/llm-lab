"""
landscape.py — tiny utilities for the Module 12 notebook.

This module has no training code. Module 12 is the concepts/map module for Part 4;
the actual post-training runs start in Module 13. These helpers exist so the
...
On a GPU it's instant. The fine-tuning runs themselves (Modules 13-16) target
