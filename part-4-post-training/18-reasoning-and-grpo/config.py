"""The composed config for Module 18 — Reasoning and GRPO.

Mirrors Module 17's `config.py` (single source of truth, YAML loader, dotted
...
class ModelConfig:
    ...
    Same two-model pattern as Module 17:
...
class TrainingConfig:
    """Loop-level knobs. Carry over from Module 17 with GRPO-tuned defaults.
...
if __name__ == "__main__":
    cfg = TrainConfig()
    cfg.sync()
    print("--- TrainConfig defaults (Module 18 Reasoning and GRPO) ---")
