"""The Module 18 GRPO entrypoint. Launch via `torchrun`.
...
The composition mirrors Module 17 — same FSDP wrap, same AdamW, same DCP
...
Activation checkpointing + FSDP wrap order is the same as Module 17:
...
def _parse_args(argv):
    p = argparse.ArgumentParser(
        description="Module 18 Reasoning and GRPO entrypoint",
...
def _log_startup(rinfo, cfg: TrainConfig, policy, device: str) -> None:
    ...
    print("=" * 64)
    print("Module 18 — Reasoning and GRPO")
    print("=" * 64)
