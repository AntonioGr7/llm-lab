"""The Module 16 DPO/IPO entrypoint. Launch via `torchrun`.
...
def _parse_args(argv):
    p = argparse.ArgumentParser(
        description="Module 16 Preference Optimization (DPO/IPO) entrypoint",
...
def _log_startup(rinfo, cfg: TrainConfig, policy, frac_chosen: float, frac_rejected: float, device: str) -> None:
    ...
    print("=" * 64)
    print("Module 16 — Preference Optimization (DPO/IPO)")
    print("=" * 64)
