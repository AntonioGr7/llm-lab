...
def _parse_answer_int(text: str) -> int | None:
    ...
    Reused for GSM8K scoring — same conventions as M18's eval.
    """
...
def _parse_args(argv=None):
    p = argparse.ArgumentParser(description="Module 19 two-axis distillation eval")
