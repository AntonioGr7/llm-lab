"""The composed config for Module 19 — Distillation.
...
GRPO-specific knobs from Module 18 are gone — distillation doesn't need
...
class DataConfig:
    ...
    `gsm8k_source`/`gsm8k_subset`/`gsm8k_split`:
        ...
        `openai/gsm8k` test set Module 18 uses, so prior-skill accuracy
        directly compares against our M18 numbers.
    ...
    # GSM8K prior-skill eval (reuses M18's loader logic)
...
# =============================================================================
# YAML loader + CLI overrides (verbatim from Module 18's pattern)
# =============================================================================
...
if __name__ == "__main__":
    cfg = TrainConfig()
    cfg.sync()
    print("--- TrainConfig defaults (Module 19 Distillation) ---")
