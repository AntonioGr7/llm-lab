"""Data pipeline for Module 18 — Distillation.
...
This file's responsibilities:
  ...
  3. Provide a `load_tokenizer` helper with LEFT padding (required for
     `model.generate`).
  4. Reuse Module 17's GSM8K loader for the prior-skill eval anchor
...
def load_tokenizer(name: str, padding_side: str = "left"):
    """LEFT-padded tokenizer for generation. (Same as Module 17.)"""
...
# =============================================================================
# GSM8K prior-skill eval — copied verbatim from Module 17 (framework dir pattern)
# =============================================================================
...
def parse_gsm8k_ground_truth(answer_field: str) -> int | None:
    """Pull the integer after `#### ` from a GSM8K answer field. (Same as M17.)"""
