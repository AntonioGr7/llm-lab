...
# In Module 11 the schedule config lives in the composed `config.py` (so the
# whole TrainConfig is one tree). Module 09 ships its own ScheduleConfig
# dataclass inline — same fields, same defaults.
